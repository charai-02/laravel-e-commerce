            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('store') }}" enctype="multipart/form-data">
                        @csrf
                        <table>
                            <tr><td>name in frensh</td><td><input type="text" name="p_name_fr"></td></tr>
                            <tr><td>name in arabic</td><td><input type="text" name="p_name_ar"></td></tr>
                            ...
                            <tr><td>image icon</td><td><input type="file" name="p_3rd_img"></td></tr>
