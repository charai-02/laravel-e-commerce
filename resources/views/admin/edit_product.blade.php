            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('update_product', $product->id) }}" enctype="multipart/form-data">
                        @csrf
                        <table>
                            <tr><td>name</td><td><input type="text" name="p_name_fr" value="{{$product->p_name_fr}}"></td></tr>
                            <tr><td>categorie</td><td><input type="text" name="p_name_ar" value="{{$product->p_name_ar}}"></td></tr>
                            ...
                            <tr><td>3ème image</td><td><input type="file" name="p_3rd_img"></td></tr>
